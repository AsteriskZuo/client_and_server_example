...
//    LoadStringW(hInstance, IDC_WINDOWSIOCTL, szWindowClass, MAX_LOADSTRING);
...
//    }
//
//    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINDOWSIOCTL));
//
//    MSG msg;
//
//    // 主消息循环:
...
//    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINDOWSIOCTL));
//    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
//    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
//    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINDOWSIOCTL);
